#!/usr/bin/env python3
"""Problem 6: list (at least) five implicit assumptions of mean-variance optimization."""
...
ANSWER = """# Problem 6 — Implicit assumptions of MVO
...
def main() -> None:
    ...
    (MD / "06_mvo_assumptions.md").write_text(ANSWER, encoding="utf-8")
    print("wrote md_files/06_mvo_assumptions.md")
